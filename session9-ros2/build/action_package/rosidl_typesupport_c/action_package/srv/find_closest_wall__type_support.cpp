...
static const _FindClosestWall_Request_type_support_symbol_names_t _FindClosestWall_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, action_package, srv, FindClosestWall_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, action_package, srv, FindClosestWall_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, action_package, srv, FindClosestWall_Request)() {
  return &::action_package::srv::rosidl_typesupport_c::FindClosestWall_Request_message_type_support_handle;
}
...
static const _FindClosestWall_Response_type_support_symbol_names_t _FindClosestWall_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, action_package, srv, FindClosestWall_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, action_package, srv, FindClosestWall_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, action_package, srv, FindClosestWall_Response)() {
  return &::action_package::srv::rosidl_typesupport_c::FindClosestWall_Response_message_type_support_handle;
}
...
static const _FindClosestWall_type_support_symbol_names_t _FindClosestWall_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, action_package, srv, FindClosestWall)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, action_package, srv, FindClosestWall)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, action_package, srv, FindClosestWall)() {
  return &::action_package::srv::rosidl_typesupport_c::FindClosestWall_service_type_support_handle;
}
