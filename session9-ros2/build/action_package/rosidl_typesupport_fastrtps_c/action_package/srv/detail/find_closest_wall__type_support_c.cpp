...
#include "action_package/srv/detail/find_closest_wall__rosidl_typesupport_fastrtps_c.h"
...
using _FindClosestWall_Request__ros_msg_type = action_package__srv__FindClosestWall_Request;
...
size_t get_serialized_size_action_package__srv__FindClosestWall_Request(
  const void * untyped_ros_message,
...
static uint32_t _FindClosestWall_Request__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_action_package__srv__FindClosestWall_Request(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_action_package
size_t max_serialized_size_action_package__srv__FindClosestWall_Request(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = action_package__srv__FindClosestWall_Request;
    is_plain =
      (
...
static size_t _FindClosestWall_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_action_package__srv__FindClosestWall_Request(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, action_package, srv, FindClosestWall_Request)() {
...
using _FindClosestWall_Response__ros_msg_type = action_package__srv__FindClosestWall_Response;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_action_package
size_t get_serialized_size_action_package__srv__FindClosestWall_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _FindClosestWall_Response__ros_msg_type * ros_message = static_cast<const _FindClosestWall_Response__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_action_package__srv__FindClosestWall_Response(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_action_package
size_t max_serialized_size_action_package__srv__FindClosestWall_Response(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = action_package__srv__FindClosestWall_Response;
    is_plain =
      (
...
static size_t _FindClosestWall_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_action_package__srv__FindClosestWall_Response(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, action_package, srv, FindClosestWall_Response)() {
...
// already included above
// #include "action_package/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
#include "action_package/srv/find_closest_wall.h"
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, action_package, srv, FindClosestWall)() {
