...
#include "action_package/srv/detail/find_closest_wall__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = action_package::srv::FindClosestWall_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const action_package::srv::FindClosestWall_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<action_package::srv::FindClosestWall_Request *>(
    untyped_ros_message);
...
{
  return &action_package::srv::typesupport_fastrtps_cpp::_FindClosestWall_Request__handle;
}
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = action_package::srv::FindClosestWall_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const action_package::srv::FindClosestWall_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<action_package::srv::FindClosestWall_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &action_package::srv::typesupport_fastrtps_cpp::_FindClosestWall_Response__handle;
}
...
{
  return &action_package::srv::typesupport_fastrtps_cpp::_FindClosestWall__handle;
}
